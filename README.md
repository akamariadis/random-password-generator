...
This repository includes only the core code for a random password generator and does not contain the additional files required to run the program (executable file).
